<%@ Page Language="VB" AutoEventWireup="false" CodeFile="swift_full.aspx.vb" Inherits="swift_full" %>
    ...
    <input type="hidden" id="reason" runat="server" />
       ...
       <div class="wrap">
           ...
           <input id="Button2" 
               ...
               type="button" value="Push to Swift" runat="server" onserverclick="swiftPush" 
               onclick="this.value='Pushing...'; this.disabled=true;" />&nbsp;&nbsp;
               <br /><br /><br />
           <input id="Button1" 
               style="font-family: 'segoe ui Light'; font-size: 16px; font-weight: bold; width: 169px; height: 35px;" 
           ...
           <br />
           <br />
           </span><input type="hidden" id="ans" runat="server" />
