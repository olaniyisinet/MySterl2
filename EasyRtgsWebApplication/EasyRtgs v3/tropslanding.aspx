<%@ Page Language="VB" AutoEventWireup="false" CodeFile="tropslanding.aspx.vb" Inherits="main"     %>
...
<body>
    ...
    <div id="header" class="style1">
       ...
       <div id="content">
       <div class="wrap">
           <strong class="style3">Landing Page</strong><br />
           <br />
           Welcome,
           ...
           <table class="style22">
               <tr>
                   <td align="center">
                       <asp:ImageButton ID="imgBtnTropsInputter" runat="server" />
                   </td>
                   <td align="center">
                       <asp:ImageButton ID="imgBtnTropsVerifier" runat="server" />
                   </td>
               </tr>
               <tr>
                   <td>
