...
Public Class Utils
    ...
    '    If sterlingaccount.Trim().Length = 10 Then
    ...
    Public Function GetNuban(ByVal sterlingaccount As String) As String
        ...
        'Return nuban
    End Function
    Shared Function GetSwiftWindowsRemotePath() As String
        Dim source As New IniConfigSource("Rtgs.ini")
        Dim path As String = String.Empty
        path = source.Configs("Windows_SWIFT").Get("RemotePath")
        Return path
    End Function

    Shared Function GetSwiftWindowsDomain() As String
        Dim source As New IniConfigSource("Rtgs.ini")
        Dim path As String = String.Empty
        path = source.Configs("Windows_SWIFT").Get("Domain")
        Return path
    End Function

    Shared Function GetSwiftWindowsUsername() As String
        Dim source As New IniConfigSource("Rtgs.ini")
        Dim path As String = String.Empty
        path = source.Configs("Windows_SWIFT").Get("Username")
        Return path
    End Function
    Shared Function GetSwiftWindowsPassword() As String
        Dim source As New IniConfigSource("Rtgs.ini")
        Dim path As String = String.Empty
        path = source.Configs("Windows_SWIFT").Get("Password")
        Return path
    End Function
    ...
    Public Function NubanNumberRetrieval(ByVal BankAccNum As String) As String
        ...
        Dim oraConStrFromOneConfig As String = OneConfig.Text.Get("oracle_appusr")
        'OracleConn.ConnectionString = Utils.GetOraConnString()
        If Not String.IsNullOrEmpty(oraConStrFromOneConfig) Then
            OracleConn.ConnectionString = oraConStrFromOneConfig
        Else
            OracleConn.ConnectionString = Utils.GetOraConnString()
        End If
    ...
    Shared Function GetSendersCorrespondent() As String
        ...
        Dim account = source.Configs("FTP").Get("SenderAccount")
        Dim bic = source.Configs("FTP").Get("SenderBIC")

        Dim sendersCorr As String = account & vbCrLf & bic
        Return sendersCorr
    End Function

    Shared Function GetUseTestAddress() As String
        'UseTestAddress 
        Dim source As New IniConfigSource("Rtgs.ini")
        Dim linePrefix As String = String.Empty


        linePrefix = source.Configs("SWIFT").Get("UseTestAddress")
